...
export class OpenbioInfantComponent {
    constructor() {
        this.ws = new WS();
        this.payload = {
    ...
    async componentDidLoad() {
        ...
        this.ws.deviceSocket.addEventListener("message", (event) => {
            ...
            this.deviceReady =
                data.deviceStatuses && data.deviceStatuses.infant.initialized;
        });
    }
    render() {
        const params = {};
        Object.keys(this.componentContainer.attributes).forEach((index) => {
            params[this.componentContainer.attributes[index].name] =
                this.componentContainer.attributes[index].value;
        });
        return (h("div", { class: "component-container", "data-theme": this.theme }, this.deviceReady || this.forceLoadComponent ? (h("openbio-infant-details", Object.assign({}, params, { theme: this.theme, forceLoad: this.forceLoadComponent }))) : (h("div", { class: "center-container", style: { "padding-bottom": "50px" } },
    ...
    static get is() { return "openbio-infant"; }
    ...
    static get style() { return "/**style-placeholder:openbio-infant:**/"; }
}
