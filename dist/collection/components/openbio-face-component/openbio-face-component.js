...
export class OpenbioFaceComponent {
    ...
    render() {
        ...
        return (h("div", { class: "component-container", "data-theme": this.theme }, this.deviceReady || this.forceLoadComponent ?
            h("openbio-face-details", Object.assign({ theme: this.theme }, params)) :
            h("div", { class: "center-container", style: { 'padding-bottom': '50px' } },
                ...
                h("button", { class: "button is-small is-info", id: "button", style: { marginTop: "20px" }, onClick: () => this.forceLoadComponent = true }, this.translations.CONTINUE_WITHOUT_DEVICE))));
    }
