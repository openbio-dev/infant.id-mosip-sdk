...
type ServiceTimes = "FINGER" | "INFANT" | "FACE" | "MUGSHOT" | "SIGNATURE" | "BIOGRAPHY" | "SCANNER" | "PALM";
type ServiceTimesParameters = {
  personId: number,
  type: ServiceTimes,
...
export async function saveServiceTime(parameters: ServiceTimesParameters) {
  if (!url) {
